...
class YAUSMAApp {
    ...
    async applyTheme(theme) {
        return new Promise((resolve) => {
            ...
            if (themeStylesheet) {
                ...
                console.log(`🎨 Theme stylesheet updating: ${newHref}`);
                
                // Add load error handling
                const onLoad = () => {
                    console.log(`✅ Theme stylesheet loaded successfully: ${newHref}`);
                    themeStylesheet.removeEventListener('load', onLoad);
                    themeStylesheet.removeEventListener('error', onError);
                };
                
                const onError = () => {
                    console.error(`❌ Failed to load theme stylesheet: ${newHref}`);
    ...
    destroy() {
        ...
        console.log('>� YAUSMA App destroyed');
    }
}
